...
TR::CompilationInfoPerThreadRemote::processEntry(TR_MethodToBeCompiled &entry, J9::J9SegmentProvider &scratchSegmentProvider)
   ...
   try
      ...
      std::string &recentProfileInfoStr  = std::get<14>(req);
      std::string &bestProfileInfoStr    = std::get<15>(req);
...
TR::CompilationInfoPerThreadRemote::cacheResolvedMethod(TR_ResolvedMethodKey key, TR_OpaqueMethodBlock *method,
   ...
   if (!std::get<4>(methodInfo).empty())
      ...
      memcpy(entry, std::get<4>(methodInfo).data(), sizeof(TR_PersistentProfileInfo));
      }
   ...
   if (!std::get<4>(methodInfo).empty())
      ...
      memcpy(entry, std::get<5>(methodInfo).data(), sizeof(TR_PersistentProfileInfo));
      }
